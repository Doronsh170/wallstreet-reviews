...
עקרונות סגנון חובה:
1. כתוב בעברית מלאה וביישור טבעי מימין לשמאל. אל תפתח שורה, כותרת או בוליט באנגלית, בטיקר או בסימבול. אם צריך להזכיר שם באנגלית, פתח קודם במילה עברית, למשל "ספייסאיקס", "אלפבית", "מניית", "קרן", "סקטור".
...
- לאחר הפתיח חובה לחלק את הסקירה כך:
  1. "במרכז הפתיחה" או "במרכז הסקירה", לפי זמן ההרצה.
  2. "ברקע".
  3. סעיף קדימה רק אם נדרש לפי זמן ההרצה.
  4. "שורה תחתונה".
- "במרכז" יכלול 3 נקודות בלבד, הנושאים החשובים ביותר.
- "ברקע" יכלול 2 עד 3 נקודות קצרות יותר.
- כל נקודה תהיה בוליט אחד בלבד, עד 2 משפטים. לא פסקאות ארוכות.
- כל בוליט חייב להתחיל בעברית, לא באנגלית ולא בטיקר.

ערך מוסף:
כל בוליט חייב לכלול שני רכיבים:
1. מה קרה או מה בלט.
...
כתוב 3 בולטים בלבד.
כל בוליט בפורמט:
• **כותרת עברית קצרה:** עד 2 משפטים.
אם הסקירה אינה לקראת פתיחה, עדיין השתמש בכותרת "במרכז הפתיחה" רק אם היא מתאימה לזמן ההרצה. אם לא, השתמש ב-"## במרכז הסקירה".

## ברקע

כתוב 2 עד 3 בולטים בלבד.
כל בוליט קצר יותר מהבולטים במרכז.
...
כתוב בו 3 עד 4 בולטים של טריגרים, לא פסקאות כלליות.
...
- ודא שאין יותר מ-6 בולטים לפני סעיף הקדימה.
- ודא שכל שורה מתחילה בעברית ולא באנגלית או בטיקר.
...
- ודא שאין מקפים כפולים ואין מקף ארוך.
